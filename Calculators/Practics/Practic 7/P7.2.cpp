...
/*
-------------------------------------------------
Из случайных чисел от -20 до 59 сделать масив размером
7х7 напечатать его в виде тамблицы и указать индексы и
значения  найбольших елементов на главной диагонали  и
побочной.  Результат вывести на экран.
-------------------------------------------------
*/
int main()
{
    ...
    for (int i = 0; i < number_amount; i++) {//цикл заполнения матрицы
    ...
    //вывод результата
    cout << "Максимальное число главной диагонали:";
    cout << "[" << left_right[0] << "]" << "[" << left_right[1] << "]: " << max << endl;
    cout << "Максимальное число побочной диагонали:";
